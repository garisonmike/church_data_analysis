...
terminalVersion/church_reports/ (plots.py, metrics.py)


The Python package is the **reference implementation for graph logic only**.
...
- replicate analytics logic found in `terminalVersion/church_reports/ (plots.py, metrics.py)`
...
1. Study the transformations in `terminalVersion/church_reports/ (plots.py, metrics.py)`.
...
- replicate analytics from `terminalVersion/church_reports/ (plots.py, metrics.py)`
