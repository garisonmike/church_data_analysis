    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSectionTitle('Attendance by Category'),
          const SizedBox(height: 8),
          _buildAttendanceByCategoryChart(),
          const SizedBox(height: 32),

          // 2. Total Attendance Trend Line
          _buildSectionTitle('Total Attendance Trend'),
          const SizedBox(height: 8),
          _buildTotalAttendanceTrendChart(),
          const SizedBox(height: 32),

          // 3. Attendance Distribution Pie Chart
          _buildSectionTitle('Attendance Distribution'),
          const SizedBox(height: 8),
          _buildAttendanceDistributionChart(),
          const SizedBox(height: 32),

          // 4. Growth Rate Chart
          _buildSectionTitle('Attendance Growth Rate'),
          const SizedBox(height: 8),
