  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: recordsAsync.when(
        ...
        data: (records) =>
            records.isEmpty ? const _EmptyView() : _CorrelationContent(records: records),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    final incomeComponentsData = {
      'Average': [
        ...
        CategoryPoint(label: 'Emergency', value: avg((r) => r.emergencyCollection)),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text('Add weekly records to see correlation charts.',
